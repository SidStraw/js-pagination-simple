...
export function createCard({ ServiceType, StationName, BikesCapacity, StationAddress, StationUID }) {
  return /*html*/ `
      <article class="flex flex-col shadow m-4 max-w-xs">
          <img 
            src="https://source.unsplash.com/collection/1346951/400x200?sig=${StationUID}" 
            alt="${StationUID} placeholder" 
          />

          <div class="bg-white flex flex-col justify-start p-6">
              <p class="text-blue-700 text-sm font-bold uppercase pb-4">YouBike ${ServiceType}.0</p>
